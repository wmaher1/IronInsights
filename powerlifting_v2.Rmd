...
test = preProcess(validation %>% select(-c(div, total)), method = "knnImpute") # remove total and division (too many levels)
...
plot(pred.ridge, actual, 
     xlab = "Predicted Total",
     ylab = "Actual Total",
     main = "Ridge Predicted vs Actual")
abline(lm(actual ~ pred.ridge), col = "red")
```
